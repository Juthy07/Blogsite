...
const { stylePage, images } = require('../controllers/assets')
const { apiRoute, webRoute, assetsRoute } = require('./routes')
...
const assetsRouter = (app) => {
    app.get(assetsRoute.STYLE_PAGE, stylePage)
    app.get(assetsRoute.IMAGES, images)
}
